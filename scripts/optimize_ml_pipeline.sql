...
\echo '  2. Refresh materialized view (REFRESH MATERIALIZED VIEW CONCURRENTLY as a top-level statement)'
\echo '     - Do not run CONCURRENTLY inside PL/pgSQL, a DO block, or an explicit transaction'
